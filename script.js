document.addEventListener('DOMContentLoaded', () => {
    ...
    // Funkcija mēneša locījuma izveidei
    ...
    function isDayActive(day) {
        ...
        const startDate = new Date('2024-12-01T01:00:00');
    ...
    // Neaktīvā lodziņa ziņojuma parādīšana
    function showInactiveMessage(day) {
        const availableDate = new Date('2024-12-01T01:00:00');
        ...
        popupContent.innerHTML = `
            ...
            <div style="padding: 20px; text-align: center; font-size: 18px;">
                Ļauj pārsteigumam Tevi iedvesmot vēlāk! 🎄✨
            </div>
        `;
    ...
    // Pop-up atvēršana aktīvajiem lodziņiem
    function openPopup(day) {
        ...
        // Atjaunojam popup saturu ar attēla konteineru
        popupContent.innerHTML = `
            <span class="close-popup">×</span>
            <div class="popup-image-container">
                <img id="popup-image" src="images/${dayInfo.image}" alt="Dienas attēls">
            </div>
        `;

        const newPopupImage = document.getElementById('popup-image');
        
        newPopupImage.onload = () => {
            popupContainer.style.display = 'flex';
